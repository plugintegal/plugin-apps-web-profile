            ...
            <div class="col-lg-6">
              <div class="banner_content" style="text-align: center; color: white">
                ...
                <div class="flex align-items-center">
                  ...
                  <div class="watch_video text-uppercase">watch the video</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div data-class-in data-class-out="out-animation">
          <div class="container">
            <div class="row about_content align-items-center">
              <div class="col-lg-6">
                <div class="section_content">
                  ...
                  <h2
                    ...
                    class="animation-element slide-left"
                  >
                    Poltek Harber Linux User Group
                    <br />Indonesia
                  </h2>
                  <p style="text-align: justify" class="animation-element slide-left">
              ...
              <div class="col-lg-6">
                <div
                  class="about_us_image_box justify-content-center animation-element slide-right"
                >
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div style="color: white" class="animation-element slide-right">
              <h4>Web Developer</h4>
              <p>
                Di Squad ini semua anggota akan di kenalkan, belajar bersama serta sharing mengenai teknologi
                web development baik dari sisi FrontEnd maupun BackEnd, PLUGIN pun akan terus mengikuti trend
                yang sedang hangat di bidang ini.
              </p>
            </div>
            <div style="color: white" class="animation-element slide-right">
              <h4>Mobile Developer</h4>
              <p>
                Tidak jauh berbeda dari squad Web di squad ini semua anggota juga akan di kenalkan, belajar
                serta sharing mengenai teknologi yang sedang hangat di bidang mobile development. di sini
                kita akan belajar dari dasar sekali sampai ke bagian Design Pattern dan masih banyak lagi.
              </p>
            </div>
            <div style="color: white" class="animation-element slide-right">
              <h4>UI / UX Designer</h4>
              <p>
                Nah, kalo di squad ini adalah squad yang sangat unik dan menarik karena hampir semua design yang
                ada di web ini yang design adalah squad UI/UX , squad ini tentunya akan berfokus pada design pengguna,
                serta pengalaman dan kemudahan dalam menggunakan suatu aplikasi baik itu berbasis website atau mobile.usto harum soluta voluptas consequatur
              ...
              <div class="card mx-auto shadow rounded-lg" style="width: 19rem">
                <div class="align-center">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text" style="color: #17A6E7">
                      <i class="fa fa-calendar-times-o" style="color: #17A6E7"></i>
                      {{ formatDate(new Date(data.opened)) }}
                    </p>
      ...
      <div class="container">
        <div class="row footer_inner">
          <div class="col-lg-6 col-sm-12">
            ...
            <ul>
              <h3>
                <b style="color: white">Contact Information</b>
              </h3>
              <div class="row text-center">
                <div class="col-md-6">
                  <aside class="f_widget ab_widget">
                    <p align="justify" style="color: white">
                      ...
                      <a
                        style="color: #2F4574"
                        href="https://www.google.co.id/maps/place/Ndalem+Parikesit/@-6.8811978,109.1431099,3a,75y,175.22h,81.96t/data=!3m6!1e1!3m4!1s7U4CiCrUYuiXnYauUIYHNA!2e0!7i13312!8i6656!4m5!3m4!1s0x2e6fb93464361e0f:0xca4bd2a90586ebbc!8m2!3d-6.8814505!4d109.1444167"
                        target="_blank"
                      >View Map</a>
                    </p>
                  </aside>
                ...
                <div class="col-md-6">
                  <aside class="f_widget ab_widget">
                    <p align="justify" style="color: white">
                      Phone: +62 878-4811-4793
                      <br />Email:
                      <i>sekretariat@plug-in.web.id</i>
                    </p>
                  </aside>
                </div>
              </div>
            ...
            <ul>
              ...
              <a href="https://www.instagram.com/officialplugin/?hl=id">
                <img src="asset/img/instagram.png" alt srcset />
              </a>&nbsp;&nbsp;
              <a href>
                <img src="asset/img/google-plus.png" alt srcset />
              </a>&nbsp;&nbsp;
            ...
            <ul>
              <h5>
                <b style="color: white">Navigation</b>
              </h5>
              <a href="#home" style="color: white">Home</a>&nbsp;&nbsp;&nbsp;
              <a href="#about" style="color: white">About</a>&nbsp;&nbsp;&nbsp;
              <a href="#" style="color: white">Squad</a>&nbsp;&nbsp;&nbsp;
              <a href="#" style="color: white">WiyataOS</a>&nbsp;&nbsp;&nbsp;
          ...
          <div class="col-lg-6 col-sm-12">
            ...
            <form action method="post">
              ...
              <div class="form-group">
                <input type="submit" value="Sumbit" class="btn btn-primary float-right" />
                <br />
                <br />
              </div>
            </form>
...
export default {
  ...
  mounted() {
    axios
      .get("http://plugin-apps-server.herokuapp.com/api/event")
      .then(response => {
