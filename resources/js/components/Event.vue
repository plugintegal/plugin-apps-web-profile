            ...
            <b-row>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="text-center">
                      <img src="https://s.kaskus.id/r540x540/images/2019/05/02/10419174_20190502042606.jpg" alt="" width="150px" height="150px">
                    </div>
                </div>
                                ...
                                <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                    ...
                                    <b-form-group id="input-group-2" label-for="input-2">
                                        <b-form-input id="input-2" v-model="form.name" required
                                            placeholder="Ketikan nama"></b-form-input>
                                    </b-form-group>
                                    <!-- asal -->
                                    <b-form-group id="input-group-4" label-for="input-4">
                                        <b-form-input id="input-4" v-model="form.institusi" required
                                            placeholder="Ketikan asal institusi"></b-form-input>
                                    </b-form-group>
                                    <!-- email -->
                                    <b-form-group id="input-group-1" label-for="input-1">
                                        <b-form-input id="input-1" v-model="form.email" type="email" required
                                            placeholder="Ketikan Email"></b-form-input>
                                    </b-form-group>
                                    <!-- Nomor HP -->
                                    <b-form-group id="input-group-5" label-for="input-5">
                                        <b-form-input id="input-5" v-model="form.NomorHP" required
                                            placeholder="Ketikan No HP"></b-form-input>
                                    </b-form-group>
                                    <!-- Gender -->
                                    <b-form-group id="input-group-3" label-for="input-3">
                                        <b-form-select id="input-3" v-model="form.gender" :options="gender" required>
                                        </b-form-select>
                                    </b-form-group>
                                    <br>
                                    <!-- Alamat -->
                                    <b-form-group id="input-group-6" label-for="input-6" class="jarak">
                                        <b-form-textarea id="textarea" v-model="text" placeholder="Ketikan Alamat"
                                            rows="3" max-rows="6"></b-form-textarea>
                                        <pre class="mt-3 mb-0">{{ Alamat }}</pre>
                                    </b-form-group>
                                    <!-- Acara -->
                                    <b-form-group id="input-group-7" label="Pilih Acara:" label-for="input-7">
                                        <b-form-checkbox-group v-model="selected" :options="options" plain stacked>
